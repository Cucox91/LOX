...
{
    // Here we are going to define a variadic function (variable args)
    // See 18.3.1 expanation for this.
    va_list args;
...
{
    // Remember that stack top is empty. The last element is the top -1.
