...
// This is a Pointer to a Function converted to a typedef for more readability.
...
static void string()
{
    emitConstant(OBJ_VAL(copyString(parser.previous.start + 1, parser.previous.lenght - 2)));
}
